<%@ Page Language="C#" MasterPageFile="~/Customers/ServiceMaster.master"  AutoEventWireup="true"
    CodeFile="frmCustomerChatRoom.aspx.cs" Inherits="Customers_frmCustomerChatRoom" Title="Untitled Page" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                     ...
                     <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="" />
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                <td><b>Customer available to chat</b></td>
                                </tr>
                                <tr>
                                    <td align="left" style="text-align: center">
                                        <asp:GridView ID="grdCustomer" runat="server" Width="150px" BackColor="White" BorderColor="#CCCCCC"
                                 ...
                                 <tr>
                                <td><b>Employee available to chat</b></td>
                                </tr>
                                <tr>
                                    <td align="left" style="text-align: center">
                                        <asp:GridView ID="grdEmployee" runat="server" Width="150px" BackColor="White" BorderColor="#CCCCCC"
                                            BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" 
                                            GridLines="Horizontal">
                                            <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                            <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
