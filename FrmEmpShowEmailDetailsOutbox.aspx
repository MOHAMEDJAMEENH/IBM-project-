<%@ Page Language="C#" MasterPageFile="~/Employee/EmployeeMaster.master"  AutoEventWireup="true" CodeFile="FrmEmpShowEmailDetailsOutbox.aspx.cs" Inherits="Employee_FrmEmpShowEmailDetailsOutbox" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align="left">
            <h4>
             <a href="FrmEmpOutbox.aspx">Back</a>
             </h4>
            </td>
            </tr>
            <tr>
