<%@ Page Language="C#" MasterPageFile="~/Employee/EmployeeMaster.master"    AutoEventWireup="true" CodeFile="FrmEmpShowEmailDetailsInbox.aspx.cs" Inherits="Employee_FrmEmpShowEmailDetailsInbox" Title="Untitled Page" %>
...
<center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align="left">
            <h4>
             <a href="FrmEmpInbox.aspx">Back</a>
             </h4>
            </td>
            </tr>
            <tr>
