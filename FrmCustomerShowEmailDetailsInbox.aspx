<%@ Page Language="C#" MasterPageFile="~/Customers/ServiceMaster.master" AutoEventWireup="true" CodeFile="FrmCustomerShowEmailDetailsInbox.aspx.cs" Inherits="Customers_FrmCustomerShowEmailDetailsInbox" Title="Untitled Page" %>
...
<center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            <tr>
                <td bgcolor="#004B97">
                    <br />
                   <asp:Label ID="lblMail" runat="server" Text="Show Details" Font-Bold="True" 
            ...
            <td align="left">
            <h4>
             <a href="../Customers/FrmCustomerInbox.aspx">Back</a>
             </h4>
            </td>
            </tr>
            <tr>
