<%@ Page Language="C#" MasterPageFile="~/Customers/ServiceMaster.master" AutoEventWireup="true"
    CodeFile="FrmCustomerComposeMails.aspx.cs" Inherits="Customers_FrmCustomerComposeMails"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="panel1" runat="server">
        <triggers>
<asp:AsyncPostBackTrigger ControlID="rdbEmployee" EventName="CheckedChanged" />
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
                ...
                <asp:Button ID="BtnInBox" runat="server" Text="InBox" 
                    ...
                    <td align="left">
                        Employee&nbsp; :
                    <asp:RadioButton ID="rdbEmployee" GroupName="rb" runat="server" AutoPostBack="True" oncheckedchanged="rdbCustomer_CheckedChanged"
                             />
