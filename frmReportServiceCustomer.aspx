<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaste.master" AutoEventWireup="true" CodeFile="frmReportServiceCustomer.aspx.cs" Inherits="Admin_frmReportServiceCustomer" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="lblHeading" ForeColor="#990033" 
                runat="server" Text="ServiceCustomer Report"
  ...
  <div id="divCustomer" style="border: thin groove #006666; width:714px; overflow:scroll; height: 273px;">
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="spReportServiceCustomers" SelectCommandType="StoredProcedure">
      </asp:SqlDataSource>
