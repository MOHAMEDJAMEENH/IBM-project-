            ...
            <table>
                <tr>
                    ...
                    <asp:Label ID="lblInCharge" runat="server" 
                            Text="Service Customer Domain Complaint Type" BackColor="#003366" 
                ...
                <tr>
                    <td>
                        Complaint TypeId</td>
                    <td>
                       <asp:DropDownList ID="ddlComplaintType" runat="server" Height="16px" Width="122px"></asp:DropDownList>
                    </td>
                    <td>
                        </td> 
                </tr>
